...
# ㄴ 이후 브라우저에서 '15.164.220.30/php_web/index.php'를 입력하면 업데이트 된것을 확인할 수 있음
# ㄴ 다른 웹 프로그래밍 파일을 해당 github repository에 올렸다면 접근 방식은 '15.164.220.30/php_web/해당파일이름' 처럼 접근하면 됨
